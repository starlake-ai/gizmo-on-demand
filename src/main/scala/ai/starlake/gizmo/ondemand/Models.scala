...
case class StartProcessResponse(processName: String, port: Int, message: String, host: Option[String] = None, externalHost: Option[String] = None)
...
case class ProcessInfo(processName: String, port: Int, pid: Option[Long], status: String, host: Option[String] = None, externalHost: Option[String] = None)
